	...
	<?php include($this->feed);
			 foreach($fgd_games as $item): ?>
				<div style="float:left;">
					<div class="icon">
						<a href="http://flashgamedistribution.com/game_info.php?gid=<?php echo $item['game_id']; ?>"
							class="hasTooltip"  target="_blank"
							data-original-title="<strong><?php echo $item['title']; ?></strong></br><?php echo $item['short_description']?>"  />
